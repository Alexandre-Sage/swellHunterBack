...
export default function loginInvalidEmailErrorTest() {
    describe("LOG IN INVALID EMAIL ERROR",function(){
        it("Should handle posted log in from and send invalid email error", async () => {
            ...
            const credentials = { email: "inexisting", password: "qsdqsd" };
            try {
